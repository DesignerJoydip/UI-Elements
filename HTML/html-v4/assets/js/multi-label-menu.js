resizeFix = function () {
    ...
    if ($(window).width() >= 992) {
        ...
        $(".submenu").click(function(){
            // if($(this).children('ul').stop().attr('class') =='slideOpen'){
            //     $(this).children('ul').stop().delay(300).slideUp(300);
            //     $(this).children('ul').stop().removeClass('slideOpen');
            // }else{
                //  $(".slideOpen").delay(300).slideUp(300);
        ...
        $('.primary-menu').on("click",".slideOpen", function(e) { 
            alert("asd");
            $(".slideOpen").children('ul').stop().delay(300).slideUp(300);
